  ...
  describe('POST /api/users', function () {
    ...
    it('Should reject users with non-string username', function(){
        ...
        .then(invalid => {
          ...
          expect(invalid.body.message).to.include('username not valid! Needs to be a string please');
        })
    ...
    it('Should reject users with non-string password', function(){
        ...
        .then(invalid => {
          expect(invalid).to.have.status(406);
          expect(invalid.body.message).to.include('password not valid! Needs to be a string please');
        })
    ...
    it('Should reject users with non-trimmed username', function(){
        ...
        .then(invalid => {
          ...
          expect(invalid.body.message).to.include('username must not have leading or trailing spaces!');
        })
    ...
    it('Should reject users with non-trimmed password', function(){
        ...
        .then(invalid => {
          expect(invalid).to.have.status(417);
          expect(invalid.body.message).to.include('password must not have leading or trailing spaces!');
        })
    ...
    it('Should reject users with empty username', function(){
        ...
        .then(invalid => {
          ...
          expect(invalid.body.message).to.include('Username must be at least ONE character, c\'mon!');
        })
    ...
    it('Should reject users with password less than 8 characters', function(){
      const shortPass = '123';
        ...
        .then(invalid => {
          expect(invalid).to.have.status(411);
          expect(invalid.body.message).to.include('Passwords must be at least eight characters');
        })
       
    });
    it('Should reject users with password greater than 72 characters', function(){
      const longPass = '12345678910123456789101234567891012345678910123456789101234567891012345678910123';
        return chai
        .request(app)
        .post('/api/users')
        ...
        .then(invalid => {
          expect(invalid).to.have.status(411);
          expect(invalid.body.message).to.include('Passwords must be no more than seventy-two characters');
        })
    ...
    it('Should reject users with duplicate username', function(){
        ...
        .then(() => {
            ...
            expect(doubled.body.message).to.include('The username already exists');
            })
